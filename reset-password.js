...
async function updatePassword() {
    try {
        ...
        // 更新数据库
        const sql = `UPDATE User SET password = '${hashedPassword}' WHERE email = 'admin@zhi.com'`;
        ...
        console.log('- 邮箱: admin@zhi.com');
        console.log('- 密码: 123456');
        
        // 验证更新
        const verifyCmd = `sqlite3 "${dbPath}" "SELECT email, substr(password,1,30) FROM User WHERE email = 'admin@zhi.com';"`;
        console.log('\n验证更新:');
